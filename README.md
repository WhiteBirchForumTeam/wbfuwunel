...
| 📄 **常用 Matrix API 走通道**（提案）：一座通用的橋 —— pack 走 HTTP 那段相同的認證與解析、呼叫原本的 route 函式，關卡只有一份；分三批（一般已登入端點、註冊、要 UIAA 的） | [docs/design/wbf-api-bridge.md](docs/design/wbf-api-bridge.md) |
