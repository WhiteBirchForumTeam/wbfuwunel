...
| 🔧 **常用 Matrix API 走通道**（設計已同意 PR #55；批 1 的 37 支 PR #56、批 2 的 8 支 PR #63、批 3 的 20 支 PR #77 已合併，批 4 等維護者挑）：一座通用的橋 —— pack 轉成內部 HTTP request 丟進 Router，flags bit4 分流，關卡只有一份 | [docs/design/wbf-api-bridge.md](docs/design/wbf-api-bridge.md) |
